...
public class AuthController {
    ...
    public ResponseEntity<?> registerUser(@Valid @RequestBody SignUpRequest signUpRequest) {
        ...
        User user = new User(signUpRequest.getName(), signUpRequest.getUsername(),
                signUpRequest.getEmail(), signUpRequest.getPassword(),signUpRequest.getImage(),signUpRequest.isActive(),signUpRequest.isAdmin(),signUpRequest.getResetToken());
    ...
    public ResponseEntity<Object> updateStudent( @RequestBody User userDetails, @PathVariable long id) {
